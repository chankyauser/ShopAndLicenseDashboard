<?php
      ...
      if(isset($_GET['pageNo']) && !empty($_GET['pageNo']) ){
        ...
        try  
            {  
                ...
                $businessCatt_Cd = $_GET['businessCatCd'];
                if(isset($_SESSION['SAL_BusinessCat_Cd']) && $businessCatt_Cd != $_SESSION['SAL_BusinessCat_Cd']){
                    $_SESSION['SAL_Parwana_Cd'] = "All";
                }
                $_SESSION['SAL_BusinessCat_Cd'] = $businessCatt_Cd;
    ...
    <?php
                ...
                if(isset($_SESSION['SAL_View_Type']) && $_SESSION['SAL_View_Type'] == "GridView"){
                    ...
                    include 'datatbl/tblShopTableData.php';
                }
