            ...
            <div class="card-content">
                        <div class="card-body">
                           <div class="col-md-12">
                              ...
                              { ?>
                              <img src="<?php echo $shop_Details['ShopOutsideImage1'];?>" width="180" height="180">
                              <?php }
                              else 
                              { ?>
                           ...
                           <div class="col-md-12" style="float:left;">
                              ...
                              { ?>
                                 <img src="<?php echo $shop_Details['ShopOutsideImage2'];?>" width="180" height="180">&nbsp;&nbsp;
                              <?php } ?>   
                              </div>
                              <div class="img_div" style="float:left;">
                              <?php if($shop_Details["ShopInsideImage1"] != '')
                              { ?>
                                 <img src="<?php echo $shop_Details['ShopInsideImage1'];?>" width="180" height="180">&nbsp;&nbsp;
                              <?php } ?>   
                              </div>
                              <div class="img_div" style="float:left;">
                              <?php if($shop_Details["ShopInsideImage2"] != '')
                              { ?>
                                 <img src="<?php echo $shop_Details['ShopInsideImage2'];?>" width="180" height="180">&nbsp;&nbsp;</br></br>
                              <?php } ?> 
                              </div>
