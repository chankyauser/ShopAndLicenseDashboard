...
if(!isset($_SESSION['SAL_Mobile']))
{
    ...
    if(isset($_SESSION['SAL_UserName']) && isset($_SESSION['SAL_AppName']) && isset($_SESSION['SAL_UserType']) && ( $_SESSION['SAL_UserType'] == 'QC' || $_SESSION['SAL_UserType'] == 'Admin' )  ){
           // header('Location:index.php');  
    }else if(isset($_SESSION['SAL_UserName']) && isset($_SESSION['SAL_AppName']) && isset($_SESSION['SAL_UserType']) && $_SESSION['SAL_UserType'] == 'Admin'  ){
