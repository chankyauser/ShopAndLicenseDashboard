<?php
    ...
    if($qcType=="ShopList"){
        ...
        $query = "SELECT * FROM ( SELECT top (5) sm.Shop_Cd, 
            ISNULL(sm.Shop_UID,'') as Shop_UID, 
            ISNULL(sm.ShopName,'') as ShopName, 
            ISNULL(sm.ShopKeeperName,'') as ShopKeeperName, 
            ISNULL(sm.ShopKeeperMobile,'') as ShopKeeperMobile, 
...
<?php if(sizeof($ShopListData)>0){ ?>
    <div class="col-xl-4 col-md-4 col-xs-12" style="display:none;">
        <div class="card">
            <div class="card-header">
                <h4>QC <?php if($qcType=="ShopList"){ echo "Shop List"; }else if($qcType=="ShopSurvey"){ echo "Shop Survey"; }else if($qcType=="ShopDocument"){ echo "Shop Document"; }else if($qcType=="ShopCalling"){echo "Shop Calling"; } ?> (<?php if( sizeof($ShopTotalData)>0){ echo $ShopTotalData[""]; }else{ echo "0"; } ?>)</h4>
                                ...
                                <td>
                                   ...
                                   <?php 
                                    ...
                                    $Shop_Cd = $shopData["Shop_Cd"];
                                        ...
                                        }else if($qcType=="ShopSurvey" || $qcType=="ShopDocument" || $qcType=="ShopCalling" ){
 ...
 <?php } ?>
    ...
    <div class="col-xl-12 col-md-12 col-xs-12" id="setShopQCFormDataId">
