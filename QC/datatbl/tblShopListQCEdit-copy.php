    ...
    <div class="col-xl-4 col-md-4 col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4>QC <?php if($qcType=="ShopList"){ echo "Shop List"; }else if($qcType=="ShopSurvey"){ echo "Shop Survey"; }else if($qcType=="ShopDocument"){ echo "Shop Document"; }else if($qcType=="ShopCalling"){echo "Shop Calling"; } ?> (<?php echo sizeof($ShopListData); ?>)</h4>
