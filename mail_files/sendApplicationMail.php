...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(!empty($operation)){
        if($operation === 'shopApplication'){
            ...
            $query = "SELECT * FROM ShopMaster WHERE Shop_Cd = '$ShopCd'";

            $Message = "<html>
                            <body style='font-family: Arial, sans-serif;'>
                                <p>Dear Mr./Ms. $ShopKeeperName,</p>
                                <p>Greetings from Chhatrapati Sambhajinagar Municipal Corporation.</p>
                                <p>We have successfully received your application for a <strong>Trade License</strong> for the period <strong>$ValidFrom to $ValidTo</strong>, for the shop <strong>$ShopName</strong> located at <strong>$ShopAddress</strong>.</p>
                                <p>Your application reference number is <strong>$ShopCd</strong>.</p>
                                <p>Our team will now verify the submitted details and documents. Once the verification process is complete and your application is approved, your license copy will be issued and sent to you via email or will be made available for download from the Shop and License Dashboard.</p>
                                <p>Please ensure your contact details are up to date. If any additional information or clarification is required, we will get in touch with you.</p>
                                <br>
                                <p>
                                    Warm regards,<br>
                                    <strong>Licensing Department</strong><br>
