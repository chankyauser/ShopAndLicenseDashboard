...
$to_Date = "";
    ...
    ISNULL(sm.ShopLicenceFile,'') as ShopLicenceFile
    FROM ShopMaster as sm
    WHERE sm.IsActive = 1
    $pocketCondition
    AND CONVERT(VARCHAR, sm.SRAssignedDate ,120) BETWEEN '$fromDate' AND '$toDate'
    AND sm.IsCertificateIssued = 1
   ;";

    $licenseShopsSurveyMapAndListDetail = $db2->ExecutveQueryMultipleRowSALData($query1, $electionName, $developmentMode);
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    - (<?php echo sizeof($licenseShopsSurveyMapAndListDetail); ?>)</h4>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="mapIcon" aria-labelledby="mapIcon-tab" role="tabpanel">
                                <div id="mapLicenseShops" style="margin-top: 15px;" class="height-500"></div>
                                
                            </div>
                            <div class="tab-pane" id="listIcon" aria-labelledby="listIcon-tab" role="tabpanel">

                                <?php 
                                    if (sizeof($licenseShopsSurveyMapAndListDetail)>0){
                                ?>
                                    <div class="table-responsive">
                                        <table  id="data-list-view1" class="table w-100" style="padding: 0px !important;">
                                            <tbody>
                                           <?php 
                                                foreach($licenseShopsSurveyMapAndListDetail as $shopData){ 
                                            ?>
                                                 <tr>
                                                    <td>
                                                                   ...
                                                                   <div class="media">
                                                                       ...
                                                                       <div class="media-body my-10px">
                                                                          ...
                                                                          ?>
                                                                           ...
                                                                           <?php if($shopData['ShopLicenceFile'] != '') { ?>
                                                                           <h6><?php echo "<b>Shop License File   :   </b>".$shopData["ShopLicenceFile"]; ?></h6>
                                                                           <?php } ?>
