                ...
                <div class="row" style="margin-top:-10px">
                    <div class="col-lg-3 col-sm-6 col-md-3 col-12">
                        <div class="form-group">
                            <label>Zone</label>
                            <select class="form-control" name="nodeName" id="nodeName" onchange="setNodeAndWardList(this.value)" >
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="OwnerName" id="OwnerName" placeholder="Search Owner Name..." style="border: 1px solid #F01954;">
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="OwnerMobile" id="OwnerMobile"  placeholder="Search Owner Mobile No..." style="border: 1px solid #F01954;">
                        </div>
                    </div>
...
<div class="container">
    <div class="card">
        <div class="card-body">
        <div class="row mb-4">
                    <h4 class="ps-2">Collection Report</h4> <span id="GetTotalRecods"></span>
                </div>
            <div class="row mt-2">
                <div class="col-12">
    ...
    var shopTable = $('#shopTable').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data) {
                    ...
                    if(data.LicenseStartDate != ""){
                        condtition = `Expired : <strong>${data.LicenseStartDate}</strong> to <strong>${data.LicenseEndDate}</strong>`;
                    }
                    return `${condtition}`;
                },
                orderable: false
            },
            {
                data: null,
                render: function (data) {
                    var RenewvalCondition = `₹${data.PaidAmount}`;
                    if(data.IsRenewal === 1){
                        RenewvalCondition = `₹${data.PaidAmount} <br> <span class="text-danger">Renewal: ₹${data.RenewalAmount}</span>`;
                    }
                    return `${RenewvalCondition} `;
                },
                orderable: false
            }
        ]
