                        ...
                        <div class="col-12 col-xl-4"> 
                            <div class="product-cart-wrap">
                                <div class="product-content-wrap">
                                    ...
                                    <?php  if($shopData["DocFlag"] == 1 && $shopData["ShopStatus"] == "Verified" && ( $shopData["ShopApproval"] == "Verified" || $shopData["ShopApproval"] == "Approved") && isset($_SESSION['SAL_UserType']) && !empty($_SESSION['SAL_UserType']) &&  ( $_SESSION['SAL_UserType']== 'Client' ) ){ ?>
                        ...
                        <div class="col-12 col-xl-1">
                            <div class="product-cart-wrap">
                                <div class="product-content-wrap" style="float: right;margin-top: 5px;">
                                    ...
                                    <?php  if(isset($_SESSION['SAL_UserType']) && !empty($_SESSION['SAL_UserType']) &&  ( $_SESSION['SAL_UserType']== 'Client' ||  $_SESSION['SAL_UserType']== 'Admin' ) ){ ?> 
