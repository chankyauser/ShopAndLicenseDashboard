                        ...
                        <div class="col-12 col-xl-4">
                            <div class="product-cart-wrap">
                                <div class="product-content-wrap">
                                    ...
                                    <button class="btn btn-sm btn-danger" id="redirectShopDetailsPage"
                                        onclick="redirectPage(<?php echo $shopData["ShopKeeperMobile"];  ?>)">Shop Owner
                                        Details</button>
                                </div>
                            </div>
                        </div>
...
function clearFilter() {
    ...
    $('input[name="OwnerMobile"]').val('');
    $('#nodeName').val('All').trigger('change');
    $('#setNodeAndWardDetailId').val('All').trigger('change');
