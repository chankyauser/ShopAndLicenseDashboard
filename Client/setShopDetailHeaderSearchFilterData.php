...
<div class="page-header breadcrumb-wrap">
    <div class="container">
        <div class="row">
                ...
                <div class="pagination-area" style="float:right;">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-start">
                            ...
                            ?>  
                                <li class="page-item"><a class="page-link" onclick="searchShopHeaderFilter(<?php echo ($loopStart - 1);  ?>)" ><i class="fi-rs-arrow-small-left"></i></a></li>
                            <?php } ?>
            ...
            <div class="col-lg-1 col-md-1 col-12 col-sm-12">
                <ul class="page-view-area" style="float:right;">
                    <li class="page-view-link" onclick="searchShopHeaderView(<?php echo $pageNo; ?>,'ListView')"><i class="fi-rs-list"></i></li>
                    <li class="page-view-link" onclick="searchShopHeaderView(<?php echo $pageNo; ?>,'GridView')"><i class="fi-rs-grid"></i></li>
                </ul>
            </div>
        </div>
    </div>
