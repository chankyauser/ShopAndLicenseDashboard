<?php
    ...
    ISNULL(Area,'') as Area
    FROM NodeMaster 
    WHERE IsActive = 1 ORDER BY Ward_No ";
    $db=new DbOperation();
                ...
                <div class="pagination-area" style="float:right;">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-start">
                            ...
                            ?>  
                                <li class="page-item"><a class="page-link" onclick="setShopSurveyBusinessCategoriesFilter(<?php echo ($loopStart - 1);  ?>, '<?php echo $businessCatCd; ?>')" ><i class="fi-rs-arrow-small-left"></i></a></li>
                            <?php } ?>
                            ...
                            <?php
                                for($i=$loopStart;$i<=$loopStop;$i++){ 
                                    ...
                                    ?>
                                    <li class="page-item <?php echo $activePageCondition; ?>"><a class="page-link" onclick="setShopSurveyBusinessCategoriesFilter(<?php echo $i; ?>, '<?php echo $businessCatCd; ?>')" ><?php echo $i; ?></a></li>
                            <?php } ?>
                            <?php if($totalRecords > $loopStop){ ?> 
                                <li class="page-item"><a class="page-link"  onclick="setShopSurveyBusinessCategoriesFilter(<?php echo ($loopStop + 1);  ?>, '<?php echo $businessCatCd; ?>')" ><i class="fi-rs-arrow-small-right"></i></a></li>
                            <?php }  ?>
