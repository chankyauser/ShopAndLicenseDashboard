                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                        <div class="detail-gallery">
                                            ...
                                            <div class="slider-nav-thumbnails">
                                                <?php if(!empty($shopDetail["ShopOutsideImage1"])){ ?>
                                                    <div><img src="<?php echo $shopDetail["ShopOutsideImage1"]; ?>" alt="Shop Image"   width="100"  height="100" /></div>
                                                <?php }else if(!empty($shopDetail["ShopOutsideImage2"])){ ?>
                                                    <div><img src="<?php echo $shopDetail["ShopOutsideImage2"]; ?>" alt="Shop Image"   width="100"  height="100"  /></div>
                                                <?php } ?>
                                                ...
                                                <?php if(!empty($shopDetail["ShopInsideImage1"])){ ?>
                                                    <div><img src="<?php echo $shopDetail["ShopInsideImage1"]; ?>" alt="Shop Image"  width="100"  height="100" /></div>
                                                <?php } ?>

                                                <?php if(!empty($shopDetail["ShopInsideImage2"])){ ?>
                                                    <div><img src="<?php echo $shopDetail["ShopInsideImage2"]; ?>" alt="Shop Image"  width="100"  height="100" /></div>
                                                <?php } ?>
                                ...
                                <div class="product-info mt-20">
                                    <div class="tab-style3">
                                        ...
                                        <div class="tab-content shop_info_tab entry-main-content">
                                            <div class="tab-pane fade show active" id="shop-detail-info">
                                                <?php 
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="invoice-inner">
                                                                        <div class="invoice-info" id="invoice_wrapper">
                                                                            ...
                                                                            <center>
                                                                                <p><b> नमुना"ख"</b> <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>(नियम १०(१)पहा) </b><span style="width: 180px;border: 1px solid rgb(7, 8, 7); text-align: left; float: right; padding-left: 5px;"><b> अनुक्रमांक : 022572 </b></span></p>
                                                                                <h2 style="color:rgb(209, 102, 26)">औरंगाबाद महानगरपालिका औरंगाबाद</h2>
                                                                                <h2> <span style="display: table; margin: 0px auto 0px auto; background-color: rgb(209, 103, 27); color: rgb(226, 192, 100); border-radius: 10px;">&nbsp;स्थानिक संस्था नोंदणी प्रमाणपत्र&nbsp;</span></h2>
                                                                            </center>
                                                                            <b style="font-size: 17px;">नोंदणी क्रमांक :</b>
                                                                            <div style="padding-left: 20px;">
                                                                                | 2 | 6 | 2 | 2 | 6 | 1 | 6 | 6 | 3 |
                                                                             </div>   


                                                                            <p style="text-align:justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;प्रमाणित करण्यात येते की,श्री./सर्वश्री <span style="color: black;"><b>मंजुश्री संजीव सावजी</b></span> 
                                                                                 यांचे शहरातील <span style="color: black;"><b>हर्ष मेडिको अँड जनरल, प्लॉट नं-४, विजयनगर, गारखेडा, औरंगाबाद</b></span> 
                                                                                 हे एकमेव / मुख्य व्यवसायाचे ठिकाण असून तेथे आपला <span style="color: black;"><b>.औषधी</b></span> व्यवसाय करीतअसून त्यांची दिनांक <span style="color: black;"><b>1/7/2011</b></span> पासून मुंबई प्रांतिक महानगरपालिका 
                                                                            ...
                                                                            <p>हा व्यापारी खाली नमूद केलेल्या सोपीव कामाच्या तत्वावर संस्करणाची कामे पार पाडत आहे :- 
                                                                             ...
                                                                             <b style="font-size: 17px;">ठिकाण :- <span style="color:rgb(209, 102, 26)"> औरंगाबाद</span></b>
                                                                             <br>
                                                                            <b style="font-size: 17px;">दिनांक :- 22/12/2011</b>
                                                                            <p style="float: right;"><span style="color:rgb(209, 102, 26); ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b> उपायुक्त</b></span> <br> महानगरपालिका औरंगाबाद</p>  
