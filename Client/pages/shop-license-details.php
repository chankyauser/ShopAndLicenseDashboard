...
<?php 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-12 text-right"   style="margin-top: 25px;">
                                     <div class="form-group">
                                        ...
                                        <button type="button" name="refesh" class="btn btn-primary" onclick="getLicenseSurveyAllDetail()" >Refresh</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <div id="shopLicenseSurveyDetailId">                               
        <?php include 'datatbl/tblGetShopLicenseDetails.php'; ?>
    </div>    
