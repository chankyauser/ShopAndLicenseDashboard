...
<?php if(isset($_GET['p'])){ $_SESSION['SAL_Page_Name'] = $_GET['p']; } ?>
    
<?php 
    if(isset($_GET['docStatus'])){
        $_SESSION['SAL_Document_Status'] = $_GET['docStatus'];
    }

    if(isset($_GET['licStatus'])){
        $_SESSION['SAL_License_Status'] = $_GET['licStatus'];
    }
    ...
    include 'setShopLicenseDetailFilterData.php'; 


    if(isset($_SESSION['SAL_View_Type']) && $_SESSION['SAL_View_Type'] == "GridView"){
        include 'datatbl/tblShopLicenseDetailGridData.php';
    }
    else if(isset($_SESSION['SAL_View_Type']) && $_SESSION['SAL_View_Type'] == "ListView"){
        include 'datatbl/tblShopLicenseDetailListData.php';
    }
    else if(isset($_SESSION['SAL_View_Type']) && $_SESSION['SAL_View_Type'] == "TableView"){
        include 'datatbl/tblShopLicenseDetailTableData.php';
    }
