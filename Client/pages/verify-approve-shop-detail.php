    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select class="form-control" disabled="true" name="parwanaDetail" onchange="setDisplayParwanaAmount(this.value)">
                    <option value="">--Select--</option>
                        <?php   
        ...
        <div class="col-sm-6 col-md-3">
            <div class="form-group">
                ...
                <input class="form-control" name="ownerMobile" type="text" value="<?php echo $getShopOwnerMobile; ?>" placeholder="Shop Owner Mobile No" pattern="[0-9]{10}" maxlength="10" onkeypress="return isNumber(event)" />
            </div>
        </div>
