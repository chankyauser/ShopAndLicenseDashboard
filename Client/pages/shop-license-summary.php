    ...
    <div class="container mt-10 mb-10">
        <?php 
            ...
            $queryDemandRevenueSummary = "SELECT
                ...
                (SELECT COALESCE(SUM(CAST(COALESCE(View_ShopLicenseAnalysis.IsActive,0) as int)),0) FROM View_ShopLicenseAnalysis INNER JOIN ShopMaster on ( View_ShopLicenseAnalysis.Shop_Cd = ShopMaster.Shop_Cd AND ShopMaster.IsActive=1 AND ShopMaster.ShopStatus = 'Verified' AND ( ISNULL(ShopApproval,'') = 'Approved' AND ShopApprovalDate IS NOT NULL ) AND ( BillGeneratedFlag = 1 AND BillGeneratedDate IS NOT NULL ) ) INNER JOIN ShopBilling on (ShopBilling.Shop_Cd = ShopMaster.Shop_Cd) ) as BilledShops,
                ISNULL((SELECT COUNT(DISTINCT(ShopMaster.Shop_Cd)) FROM ShopMaster INNER JOIN PocketMaster ON ( ShopMaster.Pocket_Cd = PocketMaster.Pocket_Cd AND PocketMaster.IsActive = 1 ) INNER JOIN NodeMaster ON PocketMaster.Node_Cd = NodeMaster.Node_Cd WHERE ShopMaster.IsActive=1 AND ShopMaster.ShopStatus = 'Verified' AND ( ISNULL(ShopApproval,'') = 'Approved' AND ShopApprovalDate IS NOT NULL ) AND ( BillGeneratedFlag = 1 AND BillGeneratedDate IS NOT NULL ) ),0) as LicenseGenerated,
                (SELECT COALESCE(SUM(CAST(COALESCE(TransactionDetails.Amount,0) as int)),0) FROM View_ShopLicenseAnalysis INNER JOIN ShopMaster on ( View_ShopLicenseAnalysis.Shop_Cd = ShopMaster.Shop_Cd AND ShopMaster.IsActive=1 AND ShopMaster.ShopStatus = 'Verified' AND ( ISNULL(ShopApproval,'') = 'Approved' AND ShopApprovalDate IS NOT NULL ) AND ( BillGeneratedFlag = 1 AND BillGeneratedDate IS NOT NULL ) ) INNER JOIN ShopBilling on (ShopBilling.Shop_Cd = ShopMaster.Shop_Cd) INNER JOIN TransactionDetails on (TransactionDetails.Billing_Cd = ShopBilling.Billing_Cd AND TransactionDetails.TransStatus = 'Done' ) ) as RevenueCollectedAmount ";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="index.php?p=survey-shops&nodeName=All&nodeId=All&docStatus=DocVerified">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            <h6 class="icon-box-title">Documents Verified</h6>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="index.php?p=survey-shops&nodeName=All&nodeId=All&docStatus=DocInReview">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            <h6 class="icon-box-title">Documents In-Review</h6>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="index.php?p=survey-shops&nodeName=All&nodeId=All&docStatus=DocDenied">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        <div class="banner-icon">
                                            <img src="assets/imgs/theme/icons/Non-Cooperative.png" alt="" />
                                        </div>
                                        <div class="banner-text">
                                            <h6 class="icon-box-title">Documents Denied</h6>
                                            <p class="text-bold-700 mb-0"><?php echo IND_money_format($surveyTotalData["PermissionDenied"]+$surveyTotalData["PermanentlyClosed"]+$surveyTotalData["NonCooperative"]); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="index.php?p=survey-shops&nodeName=All&nodeId=All&docStatus=DocPending">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            <h6 class="icon-box-title">Documents Pending</h6>
                                            <!-- <p class="text-bold-700 mb-0"><?php echo IND_money_format($surveyTotalData["SurveyPending"]+$surveyTotalData["SurveyDocPending"]); ?></p> -->
                                            <p class="text-bold-700 mb-0"><?php echo IND_money_format(1134); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="index.php?p=shop-license&nodeName=All&nodeId=All&docStatus=Verified&licStatus=Approved">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            <h6 class="icon-box-title">Shops Licensed</h6>
                                            <p class="text-bold-700 mb-0"><?php echo IND_money_format($demandRevenueSummaryData["LicenseGenerated"]); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="index.php?p=shop-license&nodeName=All&nodeId=All&docStatus=Verified&licStatus=Approved">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            ...
                                            <p class="text-bold-400 mb-0"><?php echo IND_money_format($surveyTotalData["LicenseApproved"]); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <a href="index.php?p=survey-shops&nodeName=All&nodeId=All&docStatus=DocInReview">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            <h6 class="icon-box-title">Demand Collected</h6>
                                            <p class="text-bold-700 mb-0"> <i class="fa-solid fa-indian-rupee-sign"></i> <?php echo IND_money_format($demandRevenueSummaryData["RevenueCollectedAmount"])."/-"; ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <a href="index.php?p=survey-shops&nodeName=All&nodeId=All&docStatus=DocVerified">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            <h6 class="icon-box-title">Demand Remaining</h6>
                                            <p class="text-bold-700 mb-0"> <?php echo IND_money_format($demandRevenueSummaryData["TotalRevenueAmount"]-$demandRevenueSummaryData["RevenueCollectedAmount"])."/-"; ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
     ...
     <?php
        ...
        $db1 = new DbOperation();
        $queryZoneTotal = "SELECT nm.NodeName,
        ...
        foreach ($surveyZoneTotalData as $key => $value){
            ...
            $totalZoneRevenueCollected = $totalZoneRevenueCollected + round(($value["RevenueCollectedAmount"]/100000),2);
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <!-- <h6>Zone : <?php echo "All Zone"; ?> </h6> -->
                                            <div id="chart1"></div>
                                                ...
                                                var options = {
                                                    series: [{
                                                      name: 'Shops Licensed - <?php echo $totalZoneLicensedShops."/".$totalZoneListedShops; ?>',
                                                      type: 'column',
                                                      ...
                                                      type: 'column',
                                                      data: [<?php foreach ($surveyZoneTotalData as $key => $value) {
                                                            echo round(($value["RevenueCollectedAmount"]/100000),2).",";
                                                      } ?>]
                                                    }, {
                                        ...
                                        <div class="row">
                                            ...
                                            <?php
                                                ...
                                                foreach ($surveyWardTotalData as $key => $value){
                                                    ...
                                                    $totalWardRevenueCollected = $totalWardRevenueCollected + round(($value["RevenueCollectedAmount"]/100000),2);
                                                ...
                                                $totalWardRevenueCollected = IND_money_format($totalWardRevenueCollected);
                                                                            ...
                                                                            <script type="text/javascript">
                                                                                var options<?php echo $sr_No ?> = {
                                                                                    series: [{
                                                                                      ...
                                                                                      name: 'Demand Collected - <?php echo $totalWardRevenueCollected ?> ( in Lacs )',
                                                                                      type: 'column',
                                                                                      data: [<?php foreach ($surveyWardTotalData as $key => $value) {
                                                                                            echo round(($value["RevenueCollectedAmount"]/100000),2).",";
                                                                                      } ?>]
                                                                            ...
                                                                            <table class="table table-striped table-bordered table-10">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th style="text-align: left;">License Status</th>
                                                                                        <th style="text-align: left;">Shops Visited</th>
                                                                                        <th style="text-align: left;">Documents Verified</th>
                                                                                        <!-- <th style="text-align: left;">License Verified</th> -->
                                                                                        <th style="text-align: left;" class="text-success">License Approved</th>
                                                                                        <th style="text-align: left;" class="text-danger">License Rejected</th>
                                                                                        <!-- <th style="text-align: left;">License Generated</th> -->
                                                                                        <th style="text-align: left;">Revenue Collected</th>
