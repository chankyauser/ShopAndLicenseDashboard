...
<?php 
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12 text-right"   style="margin-top: 25px;">
                                     <div class="form-group">
                                        <label for="refesh" ></label>
                                        <button type="button" name="refesh" class="btn btn-primary" onclick="getCallingSurveyAllDetail()" >Refresh</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <div id="shopCallingSurveyDetailId">                               
        <?php include 'datatbl/tblGetShopCallingDetails.php'; ?>
    </div>    
