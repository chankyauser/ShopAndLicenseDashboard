                        ...
                        <div class="login_wrap widget-taber-content background-white">
                            <div class="padding_eight_all bg-white">
                                ...
                                <div class="form-group">
                                    ...
                                    <button id="submitLoginBtnId" type="button" class="btn btn-brand btn-block hover-up"
                                        name="login" onclick="loginAuthentication()">Log in</button>
                                </div>
                                <div class="form-group">
...
<?php
               ...
               include 'setShopOwnerDetailFilterData.php'; 
                include 'datatbl/tblShopOwnerDetailsData.php';
            }
