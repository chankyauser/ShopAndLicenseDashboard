<?php
    ...
    $toDate = $to_Date." ".$_SESSION['EndTime'];
       ...
       $query = "SELECT
            ...
            $nodeNameCondition
            $pcktCondition
            GROUP BY sm.PLExecutive_Cd, em.ExecutiveName,lm.Mobile_No
