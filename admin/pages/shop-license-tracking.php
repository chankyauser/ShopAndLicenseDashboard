                               ...
                               <div class="row">
                                    ...
                                    <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="controls"> 
                                                <input type="input" id="shopNameNo" name="shopNameNo" value="" class="form-control" placeholder="Shop Name / Shop No" required>
                                             </div>
                                          </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 text-right">
                                          <div class="form-group">
                                             <br>
                                             <div class="controls"> 
                                                   <button type="button" class="btn btn-primary mr-1 mb-1" onclick="ShowDiv()">Track</button>
                                             </div>
                                          </div>
                                    </div>
...
<section id="tracking-details">
<div class="row" style="display:none;" id="trackingdetails">
...
if(isset($_GET['shop_Cd'])){
   ...
   FROM ShopDocuments WHERE Shop_Cd = $shop_Cd;";
         ...
         <div class="card-content">
            <div class="card-body">
               ...
               <div class="col-md-12" style="float:left;">
                  ...
                  { ?>
               <img src="<?php echo "https://csmcshoplicenses.com/image-proxy.php?url=".$shop_doc['FileURL']; ?>" width="180" height="180">&nbsp;
               <?php } }?> 
               <p></p><p></P>
                  </div>
                 </div>
