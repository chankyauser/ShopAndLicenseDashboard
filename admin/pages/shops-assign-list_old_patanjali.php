                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <?php  if(isset($_GET['action']) && ( $_GET['action'] == 'transfer' || $_GET['action'] == 'edit'  || $_GET['action'] == 'assign') ) {  ?>
                                ...
                                <div class="col-md-2 col-12">
                                    <div class="form-group">
                                        <label for="shops"><?php if(isset($_GET['action']) && $_GET['action'] == 'transfer'){  ?>  Transfer    <?php }   ?>  Shops Assign</label>
            ...
            <div class="card">
                <div class="card-header">
                    <h5>
                        ...
                        <?php echo " ( ".sizeof($dataShopsAssignList)." ) "; ?>
                    </h5>
                </div>
                <div class="card-content">
                                            ...
                                            <td>
                                                <div class="employee-task d-flex justify-content-between align-items-top">
                                                   ...
                                                   <div class="media-body my-10px">
                                                        ...
                                                        <h6><?php echo "Pocket : ".$value["PocketName"]; ?></h6>
                                                        <h6><?php echo "Ward : ".$value["Ward_No"]; ?></h6>
                                                        <h6><?php echo "Zone : ".$value["NodeName"]; ?></h6>
                                                    </div>
                                                </div>
                                           </td>
                                            <td>
                                                <h6><?php echo "Scheduled on ".$value["ScheduleDate"]; ?></h6>
                                                <h6><?php echo $value["Calling_Category"]; ?></h6>
                                                <h6><?php echo $value["ScheduleReason"]; ?></h6>
