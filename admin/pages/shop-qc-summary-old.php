    ...
    <div class="tab-pane active " id="qc-summary-over-all" aria-labelledby="qc-summary-over-all-tab" role="tabpanel">
        ...
        <?php
            ...
            $queryWardWiseSummary = "
                ...
                ISNULL((SELECT TOP 1 CONVERT(varchar, sm.AddedDate, 5) 
                FROM ShopMaster sm 
                INNER JOIN PocketMaster pm on (pm.Pocket_Cd = sm.Pocket_Cd AND sm.IsActive = 1 AND pm.IsActive = 1 AND sm.AddedDate IS NOT NULL) 
                ...
                ISNULL((SELECT TOP 1 CONVERT(varchar, sm.SurveyDate, 5) 
                FROM ShopMaster sm 
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                        if( round( (($valueWard["ShopSurveyQC"]/$valueWard["ShopSurvey"])*100) ) < 95 ){
                                                    ?>
                                                        <span class="badge badge-danger">
                                                ...
                                                <td>
                                                    <?php 
                                                        if( round(  (($valueWard["ShopDocumentQC"]/$valueWard["ShopDocument"]))*100 ) < 95 ){
                                                    ?>
                                                        <span class="badge badge-danger">
