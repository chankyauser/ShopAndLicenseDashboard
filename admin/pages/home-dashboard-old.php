...
<?php
  ...
  ?>
    ...
    $query2 = "SELECT
            ...
            (SELECT ISNULL(count(*),0) FROM ShopMaster WHERE IsActive = 1 AND SurveyDate is not null AND ( ISNULL(SurveyDate,'') <> '' OR ShopStatus in (SELECT ApplicationStatus as ShopStatus FROM StatusMaster WHERE ISNULL(Remark,'') = 'ShopAccess' AND IsActive = 1) ) ) as SurveyCompleted,
    ...
    <div class="row">
        ...
        ?>
            <div class="col-xl-4 col-md-4 col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Executive - Listing - <?php echo date('d/m/Y',strtotime($currentDate)); ?></h5>
                        <div class="d-flex align-items-center">
                            <p class="card-text font-small-2 mr-25 mb-0">
                        ...
                        <div class="table-responsive">
                            <!-- <table  class="table table-striped table-bordered complex-headers zero-configuration"> -->
                                ...
                                <tbody>
                                    ...
                                    ?> 
                                       <tr>
                                            ...
                                            <td style="text-align:right;font-size: 1.2rem;"><a href="home.php?p=pocket-wise-shops-list&executiveCd=<?php echo $value["Executive_Cd"]; ?>&fromDate=<?php echo $currentDate; ?>&toDate=<?php echo $currentDate; ?>&tab=listIcon&nodeId=All&pocketId=All"><?php echo $value["ShopList"]; ?></a></td>
                                        </tr>
                                    <?php
                                            }
                                        }
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Total</th>
                                        <th style="text-align:right;font-size: 1.2rem;"><?php echo $total; ?></th>
                                    </tr>
                                    <tr>
                                        <th>Average</th>
                                        <th style="text-align:right;font-size: 1.2rem;"><?php echo round(( $total / $srN1 )); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
            ...
            <div class="col-xl-4 col-md-4 col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Executive - Survey - <?php echo date('d/m/Y',strtotime($currentDate)); ?></h5>
                        <div class="d-flex align-items-center">
                            <p class="card-text font-small-2 mr-25 mb-0">
                            ...
                            <!-- <table  class="table table-striped table-bordered complex-headers zero-configuration"> -->
                                ...
                                <tbody>
                                    ...
                                    ?> 
                                       <tr>
                                            <td><?php echo $value["ExecutiveName"]; ?></td>
                                            <td style="text-align:right;font-size: 1.2rem;"><a href="home.php?p=pocket-wise-survey-detail&executiveCd=<?php echo $value["Executive_Cd"]; ?>&fromDate=<?php echo $currentDate; ?>&toDate=<?php echo $currentDate; ?>&nodeId=All&pocketId=All"><?php echo $value["ShopSurvey"]; ?></a></td>
                                        </tr>
                                    <?php
                                            }
                                        }
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th>Average</th>
                                        <th style="text-align:right;font-size: 1.2rem;"><?php echo round(( $total / $srN2 )); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
        ...
        ?>
            <div class="col-xl-4 col-md-4 col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Ward - Listing - <?php echo date('d/m/Y',strtotime($currentDate)); ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <!-- <table  class="table table-striped table-bordered complex-headers zero-configuration"> -->
                            <table class="table table-striped table-bordered table-5">
                                ...
                                <tbody>
                                    ...
                                    ?> 
                                       <tr>
                                            ...
                                            <td style="text-align:right;font-size: 1.2rem;"><a href="home.php?p=pocket-wise-shops-list&nodeId=<?php echo $value["Node_Cd"]; ?>&fromDate=<?php echo $currentDate; ?>&toDate=<?php echo $currentDate; ?>&tab=listIcon"><?php echo $value["ShopList"]; ?></a></td>
                                        </tr>
                                    <?php
                                            }
                                        }
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th>Average</th>
                                        <th style="text-align:right;font-size: 1.2rem;"><?php echo round(( $total / $srN3 )); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
            ...
            <div class="col-xl-4 col-md-4 col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Ward - Survey - <?php echo date('d/m/Y',strtotime($currentDate)); ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <!-- <table  class="table table-striped table-bordered complex-headers zero-configuration"> -->
                            <table class="table table-striped table-bordered table-5">
                                ...
                                <tbody>
                                    ...
                                    ?> 
                                       <tr>
                                            <td><?php echo "W-".$value["Ward_No"]; ?></td>
                                            <td style="text-align:right;font-size: 1.2rem;"><a href="home.php?p=pocket-wise-survey-detail&nodeId=<?php echo $value["Node_Cd"]; ?>&fromDate=<?php echo $currentDate; ?>&toDate=<?php echo $currentDate; ?>"><?php echo $value["ShopSurvey"]; ?></a></td>
                                        </tr>
                                    <?php
                                            }
                                        }
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th>Average</th>
                                        <th style="text-align:right;font-size: 1.2rem;"><?php echo round(( $total / $srN )); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <!-- <table  class="table table-striped table-bordered complex-headers zero-configuration"> -->
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th>Average</th>
                                        <th style="text-align:right;font-size: 1.2rem;"><?php echo round(( $total / sizeof($listingDaysData) )); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-5">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th>Average</th>
                                        <th style="text-align:right;font-size: 1.2rem;"><?php echo round(( $total / sizeof($surveyDaysData) )); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
