...
<?php 
                                        ...
                                        <div class="controls"> 
                                            <select class="select2 form-control" name="shopAssignFilterType" onchange="setShopAssignFilterType(this.value)">
                                                ...
                                                <?php if(isset($_SESSION['SAL_UserType']) && !empty($_SESSION['SAL_UserType']) && ( $_SESSION['SAL_UserType']== 'Admin' ) && ( $_SESSION['SAL_ElectionName']== 'PCMC' ) ){ ?> 
                                                    ...
                                                    <option <?php echo $shopAssignFilterType == 'InvalidMobilePhoto' ? 'selected' : '' ; ?> value="InvalidMobilePhoto">Invalid Mobile, Photo</option>
                                ...
                                <div class="col-md-3 col-12"  style="margin-top: 25px;">
                                    <div class="form-group">
                                        ...
                                        <?php 
                                                ...
                                                $query="SELECT 
                                                        ...
                                                        FROM(
                                                            ...
                                                            FROM shopmaster as sm inner join
                                                            PocketMaster as PM 
                                                            on
                                                            PM.Pocket_Cd = sm.Pocket_Cd
                                                            inner join
                                                            nodemaster as NM on
                                                            PM.Node_Cd = NM.Node_Cd
                                        ...
                                        <?php }else if($shopAssignFilterType == "NoDocument"){ 
                                                ...
                                                if(isset($_SESSION['SAL_UserType']) && !empty($_SESSION['SAL_UserType']) && ( $_SESSION['SAL_UserType']== 'Admin' ) && ( $_SESSION['SAL_ElectionName']== 'PCMC' ) ){
                                            ?>
                                                <button id="submitProcessScheduleShopsBtnId" type="button" name="refesh" class="btn btn-primary" onclick="setProcessScheduleShops('<?php echo $shopAssignFilterType; ?>')" >Process Scheduling</button>
                                            <?php } ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5><?php if($shopAssignFilterType=="InvalidMobilePhoto"){ ?> Invalid ShopKeeper Name or Mobile And Shop Outside Photo - <?php }else if($shopAssignFilterType=="SurveyShopReVisitUsingQuery"){ ?> Survey Re-Visit Using Query - <?php }else{ }  ?>  Shops Assigning for <?php echo $callingType; ?>  -  <?php echo date('d/m/Y',strtotime($assign_date)); ?>
                    </h5>
                </div>
                <div class="card-content">
        ...
        if($shopAssignFilterType == "New"){
            ...
            if($callingType == "Survey"){
                ...
                (
                    ...
                    AND sm.Shop_Cd = st.Shop_Cd
                    AND pm.Pocket_Cd = sm.Pocket_Cd
                    AND st.Calling_Category_Cd in ( SELECT Calling_Category_Cd FROM CallingCategoryMaster WHERE Calling_Type = 'Survey' AND QC_Type = 'ShopSurvey' )
                    AND ( 
                        --ISNULL(sm.ShopStatus,'') = '' OR 
                        sm.ShopStatus in (SELECT ApplicationStatus as ShopStatus FROM StatusMaster WHERE ISNULL(Remark,'') <> 'ShopAccess' AND IsActive = 1) 
                    )
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5><?php if($shopAssignFilterType=="InvalidMobilePhoto"){ ?> Invalid ShopKeeper Name or Mobile And Shop Outside Photo - <?php }else if($shopAssignFilterType=="SurveyShopReVisitUsingQuery"){ ?> Shop Survey Re-Visit Using Query - <?php }else{ }  ?> Executive <?php echo $callingType; ?> Summary - <?php echo date('d/m/Y',strtotime($assign_date)); ?> </h5>
                </div>
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        <div class="table-responsive">
