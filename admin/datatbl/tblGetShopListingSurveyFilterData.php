   ...
   if(isset($_SESSION['SAL_Node_Cd'])){
       ...
       if($nodeCd != 'All' ){
           ...
           if(sizeof($dataNode)>0){
            ...
            $nodeNameCondition
            --AND sm.SurveyDate IS NULL 
            AND sm.ShopStatus = 'Permission Denied' AND CONVERT(varchar,sm.AddedDate,120) BETWEEN '$fromDate' AND '$toDate' ),0)as PermissionDenied,
            ISNULL((SELECT COUNT(Shop_Cd) FROM ShopMaster as sm
            INNER JOIN PocketMaster pm on pm.Pocket_Cd = sm.Pocket_Cd
            INNER JOIN NodeMaster nm on nm.Node_Cd = pm.Node_Cd
            WHERE sm.IsActive = 1 
            ...
            $nodeNameCondition
            --AND sm.SurveyDate IS NULL 
            AND sm.ShopStatus = 'Permanently Closed' AND CONVERT(varchar,sm.AddedDate,120) BETWEEN '$fromDate' AND '$toDate' ),0)as PermanantlyClosed,
            ISNULL((SELECT COUNT(Shop_Cd) FROM ShopMaster as sm
            INNER JOIN PocketMaster pm on pm.Pocket_Cd = sm.Pocket_Cd
            INNER JOIN NodeMaster nm on nm.Node_Cd = pm.Node_Cd
            WHERE sm.IsActive = 1 
            ...
            $nodeNameCondition
            AND sm.SurveyDate IS NULL 
            AND sm.ShopStatus IS NULL AND CONVERT(varchar,sm.AddedDate,120) BETWEEN '$fromDate' AND '$toDate' ),0)as Pending,
            ISNULL((SELECT COUNT(Shop_Cd) FROM ShopMaster as sm
            INNER JOIN PocketMaster pm on pm.Pocket_Cd = sm.Pocket_Cd
            INNER JOIN NodeMaster nm on nm.Node_Cd = pm.Node_Cd
            WHERE sm.IsActive = 1 
            ...
            $nodeNameCondition
            --AND sm.SurveyDate IS NULL 
            AND sm.ShopStatus = 'Non-Cooperative' AND CONVERT(varchar,sm.AddedDate,120) BETWEEN '$fromDate' AND '$toDate' ),0)as NonCooperative,
            ISNULL((SELECT COUNT(Shop_Cd) FROM ShopMaster as sm
            INNER JOIN PocketMaster pm on pm.Pocket_Cd = sm.Pocket_Cd
            INNER JOIN NodeMaster nm on nm.Node_Cd = pm.Node_Cd
            WHERE sm.IsActive = 1 
            ...
            $nodeNameCondition
            AND sm.IsActive = 1 
            AND nm.IsActive = 1 AND pm.IsActive = 1 
            AND sm.SurveyDate IS NOT NULL
            AND ( 
            ISNULL(sm.ShopStatus,'') = '' OR 
            sm.ShopStatus in 
            ...
            $nodeNameCondition
            AND sm.SurveyDate IS NOT NULL
			AND ShopStatus = 'Verified'
            AND CONVERT(varchar,sm.AddedDate,120) BETWEEN '$fromDate' AND '$toDate' ),0)as QCVerified,
            ISNULL((SELECT COUNT(sm.Shop_Cd) FROM ShopMaster as sm
            INNER JOIN PocketMaster pm on pm.Pocket_Cd = sm.Pocket_Cd
            INNER JOIN NodeMaster nm on nm.Node_Cd = pm.Node_Cd
            WHERE sm.IsActive = 1
            ...
            $nodeNameCondition
            AND sm.SurveyDate IS NOT NULL
			AND ( sm.ShopStatus IN('Pending','In-Review','Rejected'))
            AND CONVERT(varchar,sm.AddedDate,120) BETWEEN '$fromDate' AND '$toDate' ),0)as QCRejected,
            ISNULL((SELECT COUNT(sm.Shop_Cd) FROM ShopMaster as sm
            INNER JOIN PocketMaster pm on pm.Pocket_Cd = sm.Pocket_Cd
            INNER JOIN NodeMaster nm on nm.Node_Cd = pm.Node_Cd
            WHERE sm.IsActive = 1
            ...
            $nodeNameCondition
            AND sm.SurveyDate IS NOT NULL
			AND (sm.ShopStatus IS NULL OR sm.ShopStatus = '')
            AND CONVERT(varchar,sm.AddedDate,120) BETWEEN '$fromDate' AND '$toDate' ),0)as QCPending";
            $db3=new DbOperation();
...
<!-- <div class="row">
        ...
        <div class="col-lg-2 col-sm-12 col-12">
            ...
            <div class="card">
                ...
                <div class="d-flex justify-content-between mt-2 mb-2">
                <div class="followers">
                        <p class="font-weight-bold font-medium-2 mb-0"><a href="home.php?p=listing-survey-filter&FilterType=ShopSurvey&FilterName=All"><?php echo $dataTotalCount['ShopsSurveyed'];?></a></p>
                        <span class="">Survey &nbsp;&nbsp;&nbsp;&nbsp;</br>Done</span>&nbsp;&nbsp;
                    </div>
                <div class="followers">
                        <p class="font-weight-bold font-medium-2 mb-0"><a href="home.php?p=listing-survey-filter&FilterType=ShopList&FilterName=PermanantlyClosed"><?php echo $dataTotalCount['PermanantlyClosed'];?></a></p>
                        <span class="">P &nbsp;&nbsp;&nbsp;&nbsp;</br>C</span>&nbsp;&nbsp;
            ...
            <div class="card">
                <div class="card-header d-flex align-items-start pb-0" style="text-align:center;">
                <!-- <h6 style="text-align:center;float:center;"> Survey Done Total</h6> -->

                <div class="col-lg-12 col-sm-12 col-12">
                <div class="d-flex justify-content-between mt-2 mb-2">
            
                    <div class="followers">
                        <p class="font-weight-bold font-medium-2 mb-0"><a href="home.php?p=listing-survey-filter&FilterType=ShopSurvey&FilterName=QCVerified"><?php echo $dataTotalCount['QCVerified'];?></a></p>
                        <span class="">QC &nbsp;&nbsp;&nbsp;&nbsp;</br>Verified</span>&nbsp;&nbsp;
                    </div>
                    <div class="followers">
                        <p class="font-weight-bold font-medium-2 mb-0"><a href="home.php?p=listing-survey-filter&FilterType=ShopSurvey&FilterName=QCPending"><?php echo $dataTotalCount['QCPending'];?></a></p>
                        <span class="">QC &nbsp;&nbsp;&nbsp;&nbsp;</br>Pending</span>&nbsp;&nbsp;
                    </div>
                    <div class="followers">
                        <p class="font-weight-bold font-medium-2 mb-0"><a href="home.php?p=listing-survey-filter&FilterType=ShopSurvey&FilterName=QCRejected" style="font-weight:bold;"><?php echo $dataTotalCount['QCRejected'];?></a></p>
                        <span class="">QC &nbsp;&nbsp;&nbsp;&nbsp;</br>Rejected</span>&nbsp;&nbsp;
                    </div>
                </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="d-flex justify-content-between mt-2 mb-2">
                    ...
                    <div class="followers">
                        <p class="font-weight-bold font-medium-2 mb-0"><a href="home.php?p=listing-survey-filter&FilterType=ShopSurvey&FilterName=DocumentPending"><?php echo $dataDocPen['ShopWithNoDoc'];?></a></p>
                        <span class="">Document</br>Pending</span>&nbsp;&nbsp; 
                    </div>
