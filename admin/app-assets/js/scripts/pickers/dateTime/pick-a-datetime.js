...
(function(window, document, $) {
    ...
    var minAssignDate = new Date(Date.now()-(30*24*60*60*1000));
    var maxAssignDate = new Date(Date.now()+3*24*60*60*1000);

    // assign date disable 
    $('.pickadate-disable-assigndates').pickadate({
     ...
     // Basic date disable back date
    $('.pickadate-disable-backdates').pickadate({
     ...
     // Basic date disable back date
    $('.pickadate-disable-forwarddates').pickadate({
