  ...
  if(isset($_GET['pocketCd']) && !empty($_GET['pocketCd']) ){
    ...
    try  
        {  
            ...
            if(isset($_SESSION['SAL_ListingSurveyFilterType']) && !empty($_SESSION['SAL_ListingSurveyFilterType']) && $_SESSION['SAL_ListingSurveyFilterType'] == 'ShopList')
            {
              include 'datatbl/tblGetShopListWithFilterApplied.php';
            }
            else if(isset($_SESSION['SAL_ListingSurveyFilterType']) && !empty($_SESSION['SAL_ListingSurveyFilterType']) && $_SESSION['SAL_ListingSurveyFilterType'] == 'ShopSurvey')
            {
