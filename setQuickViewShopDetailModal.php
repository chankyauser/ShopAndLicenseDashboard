...
?>
    ...
    <div class="col-md-9 col-sm-12 col-xs-12">
        <div class="detail-info pr-10">
            <h3 style="margin-bottom: 8px;"><a onclick="setShopDetailData(<?php echo $shopDetail["Shop_Cd"];  ?>)" class="text-heading"><?php echo $shopDetail["Shop_Cd"];  ?> : <?php echo $shopDetail["ShopName"];  ?></a></h3>
