                        ...
                        <div class="product-cart-wrap mb-30">
                            <div class="product-img-action-wrap">
                                ...
                                <div class="product-action-1">
                                    ...
                                    <?php  if($shopData["DocFlag"] == 1 && $shopData["ShopStatus"] == "Verified" && ( ($documentStatus=="DocVerified" || $documentStatus=="DocReceived") && ( $shopData["ShopApproval"] == "" || $shopData["ShopApproval"] == "Rejected") ) && isset($_SESSION['SAL_UserType']) && !empty($_SESSION['SAL_UserType']) &&  ( $_SESSION['SAL_UserType']== 'Ward Officer' || $_SESSION['SAL_UserName']== 'RAM_B30' ) ){ ?> 
