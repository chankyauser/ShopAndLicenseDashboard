                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="documentStatus" onchange="setShopSurveyDetailFilter(<?php echo "1"; ?>)">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            ...
                                            <?php }else if($shopData["DocFlag"] == 1 && $shopData["ShopStatus"] != "Verified" && ($documentStatus=="DocInReview" || $documentStatus=="All" || $documentStatus=="DocReceived")){ ?> 
                                            ...
                                            <?php }else if($shopData["DocFlag"] == 0 && ($documentStatus=="All" || $documentStatus=="NonCooperative" || $documentStatus=="PermissionDenied" || $documentStatus=="PermanentlyClosed")){ ?>
                                                    <span style="background-color: <?php echo $shopData["ShopStatusTextColor"]; ?>;color: #FFFFFF;padding: 5px 10px;border-radius: 5px;"><i class="<?php echo $shopData["ShopStatusFaIcon"]; ?>"></i><?php echo " ".$shopData["ShopStatus"]; ?></span>
                                            <?php } ?>
                                        </div>
                                    </td>
                                    ...
                                    <td style="text-align: center;">
                                        <?php  if($shopData["DocFlag"] == 1 && $shopData["ShopStatus"] == "Verified" && ( ($documentStatus=="DocVerified" || $documentStatus=="DocReceived") && ( $shopData["ShopApproval"] == "" || $shopData["ShopApproval"] == "Rejected") ) && isset($_SESSION['SAL_UserType']) && !empty($_SESSION['SAL_UserType']) &&  ( $_SESSION['SAL_UserType']== 'Ward Officer' || $_SESSION['SAL_UserType']== 'Admin' ) ){ ?> 
