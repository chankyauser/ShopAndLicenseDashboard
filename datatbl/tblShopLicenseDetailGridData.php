                        ...
                        <div class="product-cart-wrap mb-15">
                            <div class="product-img-action-wrap">
                                ...
                                <div class="product-action-1">
                                    ...
                                    <a aria-label="Shop Documents and License Tracking Detail" class="action-btn" href="index.php?p=shop-tracking&nodeName=All&nodeId=All&shopId=<?php echo $shopData["Shop_Cd"]; ?>" target="_blank" ><i class="fa-solid fa-truck"></i></a>
