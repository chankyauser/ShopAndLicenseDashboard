...
<?php    
    if(!isset($_SESSION['SAL_UserType'])){
        ...
        <div class="container">
            <div class="home-slide-cover mt-10">
                <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                    <!-- <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/slider-11.jpeg)">
                        <div class="slider-content"> -->
                            <!-- <h1 class="display-2 mb-40">
                                Don’t have Shop License ?<br />
                                Get it Soon to avoid Penalty!
                            </h1>
                            <p class="mb-65">Hurry Up! Reach the Corporation Office!</p> -->
                    ...
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/1.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/2.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/3.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/4.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/5.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/6.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/7.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/8.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/9.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/10.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/11.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/12.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/13.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/14.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/15.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/16.jpeg)"></div>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(assets/imgs/slider/17.jpeg)"></div>
...
<?php
    }else if(isset($_SESSION['SAL_UserType']) && $_SESSION['SAL_UserType'] == 'Ward Officer' || $_SESSION['SAL_UserType'] == 'Client' || $_SESSION['SAL_UserType'] == 'Admin'){
...
<main class="main">
            ...
            <div class="col-md-12 col-lg-5 col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12 col-lg-12 col-12">
                                <h6>Shop Documents And License Status</h6>
                                <!-- <span>  </span> -->
                            </div>
                        </div>
                    </div>
                                ...
                                <a href="index.php?p=survey-shops&nodeName=All&nodeId=All&docStatus=DocVerified">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            ...
                                            <p class="text-bold-700 mb-0"><?php echo IND_money_format($surveyTotalData["SurveyDocVerified"]); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="index.php?p=survey-shops&nodeName=All&nodeId=All&docStatus=DocInReview">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            ...
                                            <p class="text-bold-700 mb-0"><?php echo IND_money_format($surveyTotalData["SurveyDocInReview"]); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <a href="index.php?p=shop-license&nodeName=All&nodeId=All&docStatus=Verified&licStatus=Approved">
                                    <div class="banner-left-icon d-flex align-items-center wow fadeIn animated">
                                        ...
                                        <div class="banner-text">
                                            <h6 class="icon-box-title">License Generated</h6>
                                            <p class="text-bold-700 mb-0"><?php echo IND_money_format($surveyTotalData["LicenseGenerated"]); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
    ...
    <?php
        ...
        $queryZoneTotal = "SELECT ISNULL(nm.NodeName,'') as NodeName,
                ...
                ISNULL((SELECT COALESCE(SUM(CAST(COALESCE(TransactionDetails.Amount,0) as int)),0) FROM View_ShopLicenseAnalysis INNER JOIN ShopMaster on ( View_ShopLicenseAnalysis.Shop_Cd = ShopMaster.Shop_Cd AND View_ShopLicenseAnalysis.IsActive = 1 AND View_ShopLicenseAnalysis.NodeName = nm.NodeName AND ShopMaster.IsActive=1 AND ShopMaster.ShopStatus = 'Verified' AND ( ISNULL(ShopApproval,'') = 'Approved' AND ShopApprovalDate IS NOT NULL ) AND ( BillGeneratedFlag = 1 AND BillGeneratedDate IS NOT NULL ) ) INNER JOIN ShopBilling on (ShopBilling.Shop_Cd = ShopMaster.Shop_Cd) INNER JOIN TransactionDetails on (TransactionDetails.Billing_Cd = ShopBilling.Billing_Cd AND TransactionDetails.TransStatus = 'Done' ) ),0) as RevenueCollectedAmount,
                ISNULL((SELECT COALESCE(SUM(CAST(COALESCE(View_ShopLicenseAnalysis.Revenue,0) as int)),0) FROM View_ShopLicenseAnalysis INNER JOIN ShopMaster on ( View_ShopLicenseAnalysis.Shop_Cd = ShopMaster.Shop_Cd AND View_ShopLicenseAnalysis.IsActive = 1 AND View_ShopLicenseAnalysis.NodeName = nm.NodeName AND ShopMaster.IsActive=1 AND ShopMaster.SurveyDate IS NOT NULL AND ( ISNULL(ShopMaster.ShopStatus,'') = '' OR ShopMaster.ShopStatus in (SELECT ApplicationStatus as ShopStatus FROM StatusMaster WHERE ISNULL(Remark,'') <> 'ShopAccess' AND IsActive = 1) ) ) ),0) as TotalRevenueAmount
            FROM NodeMaster nm
                        ...
                        <div class="tab-content entry-main-content">
                            <div class="tab-pane fade show active" id="Shop-Status-And-Revenue-Zone-All">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h6> </h6>
                                        <!-- <h6>Zone : <?php echo "All Zone"; ?> </h6> -->
                                        <div id="chart1"></div>
                                            <script type="text/javascript">
                                                var options = {
                                                    series: [{
                                                      name: 'Total Visited - <?php echo $totalZoneListedShops; ?> Shops',
                                                      type: 'column',
                                                      data: [<?php foreach ($surveyZoneTotalData as $key => $value) {
                                                            echo $value["ShopListed"].",";
                                                      } ?>]
                                                    },{
                                                      name: 'License Generated - <?php echo $totalZoneLicensedShops ?> Shops',
                                                      type: 'column',
                                                      data: [<?php foreach ($surveyZoneTotalData as $key => $value) {
                                                            echo $value["LicenseGenerated"].",";
                                                      } ?>]
                                                    }, {
                                                      name: 'Total Revenue Demand - ₹ <?php echo $totalZoneRevenueDemand; ?> ( in Lacs )',
                                                      type: 'line',
                                                      data: [<?php foreach ($surveyZoneTotalData as $key => $value) {
                                                    ...
                                                    xaxis: {
                                                      categories: [<?php foreach ($surveyZoneTotalData as $key => $value) {
                                                            echo "'".$value["NodeName"]."',";
                                                      } ?>],
                                                      // title: {
                                                      //     text: "Ward ",
                                        ...
                                        <div class="row">
                                            ...
                                            <?php
                                                ...
                                                $queryWardTotal = "SELECT 
                                                        ...
                                                        ISNULL((SELECT COALESCE(SUM(CAST(COALESCE(TransactionDetails.Amount,0) as int)),0) FROM View_ShopLicenseAnalysis INNER JOIN ShopMaster on ( View_ShopLicenseAnalysis.Shop_Cd = ShopMaster.Shop_Cd AND View_ShopLicenseAnalysis.IsActive = 1 AND View_ShopLicenseAnalysis.Ward_No = nm.Ward_No AND View_ShopLicenseAnalysis.NodeName = '$nodeName' AND ShopMaster.IsActive=1 AND ShopMaster.ShopStatus = 'Verified' AND ( ISNULL(ShopApproval,'') = 'Approved' AND ShopApprovalDate IS NOT NULL ) AND ( BillGeneratedFlag = 1 AND BillGeneratedDate IS NOT NULL ) ) INNER JOIN ShopBilling on (ShopBilling.Shop_Cd = ShopMaster.Shop_Cd) INNER JOIN TransactionDetails on (TransactionDetails.Billing_Cd = ShopBilling.Billing_Cd AND TransactionDetails.TransStatus = 'Done' ) ),0) as RevenueCollectedAmount,
                                                        ISNULL((SELECT COALESCE(SUM(CAST(COALESCE(View_ShopLicenseAnalysis.Revenue,0) as int)),0) FROM View_ShopLicenseAnalysis INNER JOIN ShopMaster on ( View_ShopLicenseAnalysis.Shop_Cd = ShopMaster.Shop_Cd AND View_ShopLicenseAnalysis.IsActive = 1 AND View_ShopLicenseAnalysis.Ward_No = nm.Ward_No AND View_ShopLicenseAnalysis.NodeName = '$nodeName' AND ShopMaster.IsActive=1 AND ShopMaster.SurveyDate IS NOT NULL AND ( ISNULL(ShopMaster.ShopStatus,'') = '' OR ShopMaster.ShopStatus in (SELECT ApplicationStatus as ShopStatus FROM StatusMaster WHERE ISNULL(Remark,'') <> 'ShopAccess' AND IsActive = 1) ) ) ),0) as TotalRevenueAmount
                                                    FROM NodeMaster nm
                                                    WHERE nm.IsActive = 1 AND ISNULL(nm.Ward_No,0) <> 0
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-12 col-12 text-right">
                                                                <ul class="nav nav-tabs">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" id="Graphical-Shop-Status-And-Revenue-Ward-<?php echo $sr_No ?>-tab" data-bs-toggle="tab" href="#Graphical-Shop-Status-And-Revenue-Ward-<?php echo $sr_No ?>">  <i class="fa-solid fa-chart-column"></i> Graphical </a>
                                                                    </li>
                                                                    <li>
                                                                        <a class="nav-link" id="Tabular-Shop-Status-And-Revenue-Ward-<?php echo $sr_No ?>-tab" data-bs-toggle="tab" href="#Tabular-Shop-Status-And-Revenue-Ward-<?php echo $sr_No ?>">  <i class="fa-solid fa-file-invoice"></i> Shop Survey</a>
                                                                    </li>
                                                                    <li>
                                                                        <a class="nav-link" id="Tabular-Shop-Status-And-Revenue-Ward-2-<?php echo $sr_No ?>-tab" data-bs-toggle="tab" href="#Tabular-Shop-Status-And-Revenue-Ward-2-<?php echo $sr_No ?>">  <i class="fa-solid fa-file-invoice-dollar"></i> Shop License</a>
                                                                    </li>
                                                                </ul>
                                                        ...
                                                        <div class="tab-content entry-main-content">
                                                                            ...
                                                                            <script type="text/javascript">
                                                                                var options<?php echo $sr_No ?> = {
                                                                                    series: [{
                                                                                      ...
                                                                                      name: 'Total Revenue Demand - ₹ <?php echo $totalWardRevenueDemand; ?> ( in Lacs )',
                                                                                      type: 'line',
                                                                                      data: [<?php foreach ($surveyWardTotalData as $key => $value) {
                                                                                            echo round(($value["TotalRevenueAmount"]/100000),2).",";
                                                                                      } ?>]
                                                                            ...
                                                                            <table class="table table-striped table-bordered table-10">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th style="text-align: center;width: 7%;">Shops Visited</th>
                                                                                        <th style="text-align: center;width: 7%;" class="text-warning">Documents Pending</th>
                                                                                        <th style="text-align: center;width: 7%;" class="text-success">Documents Recevied</th>
                                                                                        <th style="text-align: center;width: 7%;" class="text-success">Documents Verified</th>
                                                                                        <th style="text-align: center;width: 7%;" class="text-success">Documents In-Review</th>

                                                                                        <th style="text-align: center;width: 7%;" class="text-danger">Non  Cooperative</th>
                                                                                        <th style="text-align: center;width: 7%;" class="text-danger">Permission Denied</th>
                                                                                        <th style="text-align: center;width: 7%;" class="text-danger">Permanently Closed</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                    <?php 
                                                                                        ...
                                                                                        foreach ($surveyWardTotalData as $key => $value) {
                                                                                            ...
                                                                                            $docPendingTotal = $docPendingTotal + ($value["SurveyPending"]+$value["SurveyDocPending"]);
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="text-align: right;"><a href="index.php?p=survey-shops&nodeName=<?php echo $nodeName; ?>&nodeId=<?php echo $value["Node_Cd"]; ?>&docStatus=DocPending" target="_blank"><?php echo IND_money_format($value["SurveyPending"]); ?></a></td>
                                                                                ...
                                                                                <tfoot>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th style="text-align: center;"><?php if($shopVisitedTotal!=0){ ?><span class="shop-badges bg-warning"><?php echo "".round((($docPendingTotal/$shopVisitedTotal)*100))."%"; ?></span> <span class="shop-badges bg-success"><?php echo "".round((($docReceivedTotal/$shopVisitedTotal)*100))."%"; ?></span> <span class="shop-badges bg-danger"><?php echo "".round((( ($docNCTotal+$docPDTotal+$docPCTotal)/$shopVisitedTotal)*100))."%"; ?></span><?php } ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($shopVisitedTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($docPendingTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($docReceivedTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($docVerifiedTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($docInReviewTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($docNCTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($docPDTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($docPCTotal); ?></th>
                                                                                        <!-- <th style="text-align: right;"><?php echo IND_money_format($shopRevenueTotal); ?></th> -->
                                                                                    </tr>
                                                                                </tfoot>
                                                                            </table>
                                                                        </div>
                                                            ...
                                                            <div class="tab-pane fade" id="Tabular-Shop-Status-And-Revenue-Ward-2-<?php echo $sr_No ?>">
                                                                            ...
                                                                            <table class="table table-striped table-bordered table-10">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th style="text-align: center;">Shops Visited</th>
                                                                                        <th style="text-align: center;">Documents Verified</th>
                                                                                        <th style="text-align: center;">License Verified</th>
                                                                                        <th style="text-align: center;" class="text-success">License Approved</th>
                                                                                        <th style="text-align: center;" class="text-danger">License Rejected</th>
                                                                                        <th style="text-align: center;">License Generated</th>
                                                                                        <th style="text-align: center;">Revenue Collected</th>
                                                                                        <th style="text-align: left;">Total Demand</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                    <?php 
                                                                                        ...
                                                                                        $licenseVerifiedTotal=0;
                                                                                        $licenseApprovedTotal=0;
                                                                                        $licenseRejectedTotal=0;

                                                                                        $licenseGeneratedTotal=0;
                                                                                        $shopRevenueCollectedTotal=0;
                                                                                        $shopRevenueDemandTotal=0;
                                                                                        foreach ($surveyWardTotalData as $key => $value) {
                                                                                            $srNo = $srNo + 1;
                                                                                            $shopVisitedTotal = $shopVisitedTotal + $value["ShopListed"];
                                                                                            $docVerifiedTotal = $docVerifiedTotal + $value["SurveyDocVerified"];
                                                                                            
                                                                                            $licenseVerifiedTotal = $licenseVerifiedTotal + $value["LicenseVerified"];
                                                                                            $licenseApprovedTotal = $licenseApprovedTotal + $value["LicenseApproved"];
                                                                                            $licenseRejectedTotal = $licenseRejectedTotal + $value["LicenseRejected"];
                                                                                        
                                                                                            $licenseGeneratedTotal = $licenseGeneratedTotal + $value["LicenseGenerated"];
                                                                                             $shopRevenueCollectedTotal = $shopRevenueCollectedTotal + $value["RevenueCollectedAmount"];
                                                                                            $shopRevenueDemandTotal = $shopRevenueDemandTotal + $value["TotalRevenueAmount"];
                                                                                    ?>
                                                                                        <tr>
                                                                                            <td style="text-align: center;"><?php echo $srNo; ?></td>
                                                                                            <td style="text-align: left;"><?php echo $value["Ward_No"]." - ".$value["WardArea"]; ?></td>
                                                                                            <!-- <td style="text-align: left;"><?php echo $value["WardArea"]; ?></td> -->
                                                                                            <td style="text-align: center;"><?php if($value["ShopListed"]!=0){ ?><span class="shop-badges bg-success"><?php echo "".round((( $value["LicenseApproved"]/$value["ShopListed"])*100))."%"; ?></span> <span class="shop-badges bg-danger"><?php echo "".round((($value["LicenseRejected"]/$value["ShopListed"])*100))."%"; ?></span><?php } ?></td>
                                                                                            <td style="text-align: right;"><?php echo IND_money_format($value["ShopListed"]); ?></td>
                                                                                            <td style="text-align: right;"><a href="index.php?p=shop-license&nodeName=<?php echo $nodeName; ?>&nodeId=<?php echo $value["Node_Cd"]; ?>&docStatus=Verified&licStatus=All" target="_blank"><?php echo IND_money_format($value["SurveyDocVerified"]); ?></a></td>
                                                                                            <td style="text-align: right;"><a href="index.php?p=shop-license&nodeName=<?php echo $nodeName; ?>&nodeId=<?php echo $value["Node_Cd"]; ?>&docStatus=Verified&licStatus=Verified" target="_blank"><?php echo IND_money_format($value["LicenseVerified"]); ?></a></td>
                                                                                            <td style="text-align: right;"><a href="index.php?p=shop-license&nodeName=<?php echo $nodeName; ?>&nodeId=<?php echo $value["Node_Cd"]; ?>&docStatus=Verified&licStatus=Approved" target="_blank"><?php echo IND_money_format($value["LicenseApproved"]); ?></a></td>
                                                                                            <td style="text-align: right;"><a href="index.php?p=shop-license&nodeName=<?php echo $nodeName; ?>&nodeId=<?php echo $value["Node_Cd"]; ?>&docStatus=Verified&licStatus=Rejected" target="_blank"><?php echo IND_money_format($value["LicenseRejected"]); ?></a></td>
                                                                                            <td style="text-align: right;"><?php echo IND_money_format($value["LicenseGenerated"]); ?></td>
                                                                                            <td style="text-align: right;"><?php echo IND_money_format($value["RevenueCollectedAmount"]); ?></td>
                                                                                ...
                                                                                <tfoot>
                                                                                    <tr>
                                                                                        <th colspan="2">Sub Total : <?php echo $srNo; ?> Wards </th>
                                                                                        <th style="text-align: center;"><?php if($shopVisitedTotal!=0){ ?><span class="shop-badges bg-success"><?php echo "".round((($licenseApprovedTotal/$shopVisitedTotal)*100))."%"; ?></span> <span class="shop-badges bg-danger"><?php echo "".round((($licenseRejectedTotal/$shopVisitedTotal)*100))."%"; ?></span><?php } ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($shopVisitedTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($docVerifiedTotal); ?></th>

                                                                                        <th style="text-align: right;"><?php echo IND_money_format($licenseVerifiedTotal); ?></th>
                                                                                        <th style="text-align: right;" class="text-success"><?php echo IND_money_format($licenseApprovedTotal); ?></th>
                                                                                        <th style="text-align: right;" class="text-danger"><?php echo IND_money_format($licenseRejectedTotal); ?></th>

                                                                                        <th style="text-align: right;"><?php echo IND_money_format($licenseGeneratedTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($shopRevenueCollectedTotal); ?></th>
                                                                                        <th style="text-align: right;"><?php echo IND_money_format($shopRevenueDemandTotal); ?></th>
                                                                                    </tr>
                                                                                </tfoot>
                                                                            </table>
                                                                        </div>
