                                                ...
                                                <div class="padding_eight_all">
                                                    <div class="heading_s1" style="margin-bottom: 20px;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="mobile" placeholder="Enter Mobile No" class="bg-white" maxlength="10" required  onkeypress="return (event.charCode >= 48 && event.charCode <= 57) " />
                                                        </div>
                                                        <div class="form-group" style="margin-bottom: 30px;">
                                                            <label for="" class="text-white">Password <span class="text-danger">*</span></label>
                                                            <input type="password" name="password" placeholder="Enter Password" class="bg-white" id="user-password" required  onkeydown = "if (event.keyCode == 13) document.getElementById('submitLoginBtnId').click()"/>
                                                        </div>
                                                        <div class="form-group d-flex justify-content-center">
                                                            ...
                                                            <button id="submitLoginBtnId" type="button" class="btn btn-brand" name="login" onclick="loginAuthentication()" style="border: 1px solid #fff;border-radius: 13px; width: 80%;">Log in</button>
                                                        </div>
                                                        <div class="form-group">
