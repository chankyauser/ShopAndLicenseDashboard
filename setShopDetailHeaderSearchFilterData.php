        ...
        <div class="row">
                ...
                <div class="pagination-area" style="float:right;">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-start">
                            ...
                            ?>  
                                <li class="page-item"><a class="page-link" onclick="searchShopHeaderFilter(<?php  if($loopStart==1){ echo "1"; }else{ echo ($loopStart - 1); } ?>)" ><i class="fi-rs-arrow-small-left"></i></a></li>
                            <?php } ?>
                            ...
                            <?php
                                for($i=$loopStart;$i<=$loopStop;$i++){ 
                                    ...
                                    ?>
                                    <li class="page-item <?php echo $activePageCondition; ?>"><a class="page-link" onclick="searchShopHeaderFilter(<?php echo $i; ?>)" ><?php echo $i; ?></a></li>
                            <?php } ?>
                            <?php if($totalRecords > $loopStop){ ?> 
                                <li class="page-item"><a class="page-link"  onclick="searchShopHeaderFilter(<?php echo ($loopStop + 1);  ?>)" ><i class="fi-rs-arrow-small-right"></i></a></li>
                            <?php }  ?>
            ...
            <div class="col-lg-2 col-md-2 col-12 col-sm-12">
                <ul class="page-view-area" style="float:right;">
                    <li class="page-view-link <?php if(isset($_SESSION['SAL_View_Type']) && $_SESSION['SAL_View_Type'] == "GridView"){ ?> active <?php }?>" onclick="searchShopHeaderView(<?php echo $pageNo; ?>,'GridView')"><i class="fi-rs-grid"></i></li>
                    <li class="page-view-link <?php if(isset($_SESSION['SAL_View_Type']) && $_SESSION['SAL_View_Type'] == "ListView"){ ?> active <?php }?>" onclick="searchShopHeaderView(<?php echo $pageNo; ?>,'ListView')"><i class="fi-rs-list"></i></li>
                    <li class="page-view-link <?php if(isset($_SESSION['SAL_View_Type']) && $_SESSION['SAL_View_Type'] == "TableView"){ ?> active <?php }?>" onclick="searchShopHeaderView(<?php echo $pageNo; ?>,'TableView')"><i class="fa-solid fa-table-list"></i></li>
